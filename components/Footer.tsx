...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-800 via-blue-800 to-cyan-800 text-white relative overflow-hidden">
      ...
      <div className="relative backdrop-blur-xl border-t border-cyan-500/20">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    rel={social.rel}
                    className={`w-10 h-10 bg-blue-800/60 backdrop-blur-lg border border-blue-600/50 rounded-lg flex items-center justify-center text-blue-200 ${social.color} transition-all duration-300 hover:scale-110 hover:shadow-lg hover:border-cyan-500/30`}
              ...
              <ul className="space-y-3">
                {quickLinks.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-blue-200 hover:text-cyan-400 transition-colors duration-300 flex items-center group"
                    >
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-blue-800/60 backdrop-blur-lg border border-blue-600/50 rounded-lg flex items-center justify-center">
