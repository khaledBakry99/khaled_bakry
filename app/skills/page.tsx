            ...
            <button
              ...
              className={`px-6 py-3 rounded-xl font-bold transition-all duration-300 ${
                activeCategory === key
                  ...
                  : 'bg-slate-200/80 dark:bg-slate-800/50 text-slate-700 dark:text-slate-400 hover:bg-slate-300/80 dark:hover:bg-slate-700/50'
              }`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skillCategories[activeCategory as keyof typeof skillCategories].skills.map((skill, index) => (
            <ScrollAnimation key={skill.name} animation="slideUp" delay={index * 100}>
              <div className="group relative bg-white/80 dark:bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-blue-200/30 dark:border-slate-700/50 hover:border-blue-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20">
                {/* Icon */}
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-blue-100/80 dark:bg-blue-50/10 backdrop-blur-sm rounded-full border border-blue-300/40 dark:border-blue-200/20 mb-6">
              <i className="ri-code-s-slash-line text-blue-600 dark:text-blue-400 mr-2"></i>
              <span className="text-blue-600 dark:text-blue-400 font-medium">Technical Skills</span>
            </div>
