  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900/50 to-cyan-900/60 py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-xl shadow-lg print:shadow-none print:bg-white print:text-black border border-blue-100/10">
          <div className="p-8 print:p-6">
            {/* Header */}
            <div className="text-center mb-8 print-avoid-break">
              <h1 className="text-5xl font-bold text-white print:text-black mb-2 tracking-widest">
                K H A L E D &nbsp; B A K R Y
              </h1>
              <h2 className="text-xl text-blue-400 print:text-black mb-6 tracking-wide">
                F r o n t - E n d &nbsp; R e a c t / N e x t . j s &nbsp; D e v e l o p e r
              </h2>
              <div className="flex flex-wrap justify-center gap-6 text-slate-300 print:text-black text-sm">
            ...
            <div className="mb-8 print-avoid-break">
              <h3 className="text-2xl font-bold text-white print:text-black mb-4 tracking-widest">
                A B O U T &nbsp; M E
              </h3>
              <p className="text-slate-300 print:text-black leading-relaxed text-justify">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                <div className="print-avoid-break">
                  <h4 className="font-bold text-white print:text-black mb-2">Front-End Development:</h4>
                ...
                <div className="print-avoid-break">
                  <h4 className="font-bold text-white print:text-black mb-2">Back-End Development:</h4>
                  <p className="text-slate-300 print:text-black text-sm leading-relaxed">
                ...
                <div className="print-avoid-break">
                  <h4 className="font-bold text-white print:text-black mb-2">Tools & Workflow:</h4>
                  <p className="text-slate-300 print:text-black text-sm leading-relaxed">
                ...
                <div className="print-avoid-break">
                  <h4 className="font-bold text-white print:text-black mb-2">Testing & Quality Assurance:</h4>
                  <p className="text-slate-300 print:text-black text-sm leading-relaxed">
                ...
                <div className="print-avoid-break">
                  <h4 className="font-bold text-white print:text-black mb-2">Design & Prototyping:</h4>
                  <p className="text-slate-300 print:text-black text-sm leading-relaxed">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-6">
                <div className="print-avoid-break">
                  <h4 className="text-lg font-bold text-white print:text-black mb-1">
                    1. Web for Project Management System
                  </h4>
                  <p className="text-sm text-blue-400 print:text-black mb-2 italic">
            ...
            <div className="mb-8 print-avoid-break">
              ...
              <ul className="text-slate-300 print:text-black text-sm space-y-1">
            ...
            <div className="print-avoid-break">
              ...
              <p className="text-slate-300 print:text-black text-sm">
